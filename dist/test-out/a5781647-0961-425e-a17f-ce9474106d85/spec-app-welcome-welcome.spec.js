...
var require_welcome_spec = __commonJS({
  "src/app/welcome/welcome.spec.ts"(exports) {
    ...
    init_core();
    var MockTypographyComponent = class MockTypographyComponent {
    };
    MockTypographyComponent = __decorate([
      Component({
    ...
    var MockButtonComponent = class MockButtonComponent {
    };
    MockButtonComponent = __decorate([
      Component({
        selector: "ds-button",
        standalone: false,
    ...
    describe("WelcomeComponent", () => {
      ...
      it("should render the smiley face", () => {
        const smileElement = fixture.debugElement.query(By.css(".ds-welcome-smile"));
      ...
      it("should render the ds-typography components", () => {
        const typographyElements = fixture.debugElement.queryAll(By.css("ds-typography"));
